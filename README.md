# KC Krupp Capital — Quarterly Archive

Vercel-deployed scaffold for **quarterly-archive.vercel.app**, branded with the KC **border** favicon variant from the [Krupp Capital favicon pack](/Users/maximiliankrupp/Desktop/kc-favicon-pack).

| constant        | value   |
|-----------------|---------|
| Pine Script     | `C_BORDER` |
| c1 (canonical)  | `#444455` |
| c2 (deeper)     | `#2A2A33` |
| persona         | Quarterly Archive |
...
```bash
npm run kc:deploy   # runs deploy.py --sites=quarterly-archive (idempotent)
```
